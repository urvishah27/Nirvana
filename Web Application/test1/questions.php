...
<html lang="en">
  ...
  <head>
    ...
    <link href="css/business-casual.min.css" rel="stylesheet">
 	...
 	<style>
 	.qu{
 		border-bottom: 1px solid #2C9BE8;
 	}
 </style>
            ...
            <div class="col-xl-9 col-lg-10 mx-auto">
              <div class="bg-faded rounded p-5">
                <h2 class="section-heading mb-4">
                  <span class="section-heading-lower">Questions</span>
                </h2>

                <div>
					<?php
					include "connect.php";
					$sql="Select ques,ans from questions";
					$i=1;
					...
					if($result->num_rows>0){
						...
						?>
						<div class="qu">
							<p>Q<?php echo $i." ".$row["ques"];  ?></p>
							<p>Answer: <?php echo $row["ans"];   ?> You must keep Calm..</p>
						</div>
						<?php
						$i++;
						}}
